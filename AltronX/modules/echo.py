  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
        ...
        if int(user_id) in ALTRON:
            await event.reply("» ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ ᴏᴡɴᴇʀ", parse_mode=None, link_preview=None)
        elif int(user_id) == OWNER_ID:
            await event.reply("» ɴᴏ, ᴛʜɪꜱ ɪꜱ TIGEROP ᴏᴡɴᴇʀ ᴏꜰ ᴛʜᴇꜱᴇ ʙᴏᴛꜱ", parse_mode=None, link_preview=None)
        elif int(user_id) in SUDO_USERS:
            await event.reply("» ɴᴏ, ᴛʜɪꜱ CHUTIYA ɪꜱ ᴀ ꜱᴜᴅᴏ ᴜꜱᴇʀ", parse_mode=None, link_preview=None)
        else:
            ...
            if is_echo(user_id, chat_id):
                await event.reply("» ᴇᴄʜᴏ ɪꜱ ᴀʟʀᴇᴀᴅʏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ᴏɴ ᴛʜɪꜱ CHUTIYA !!")
                return
            addecho(user_id, chat_id)
            await event.reply("» ᴇᴄʜᴏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ᴏɴ THIS CHUTIYA ✅")
     else:
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
        ...
        if is_echo(user_id, chat_id):
            ...
            await event.reply("» ᴇᴄʜᴏ ʜᴀꜱ ʙᴇᴇɴ ꜱᴛᴏᴘᴘᴇᴅ ꜰᴏʀ THIS CHUTIYA ☑️")
        else:
            await event.reply("» ᴇᴄʜᴏ ɪꜱ ᴀʟʀᴇᴀᴅʏ ᴅɪꜱᴀʙʟᴇᴅ TIGEROP SIR !!")
     else:
          await event.reply(usage)
